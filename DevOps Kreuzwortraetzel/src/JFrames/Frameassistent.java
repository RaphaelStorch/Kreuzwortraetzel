...
public class Frameassistent {
  ...
  void initFrageFeld(JTextField fragefeld) {
    ...
    fragefeld.setBorder(new TitledBorder(null, "Fragefeld", TitledBorder.LEADING, TitledBorder.TOP,
        null, Color.green));
  }
  ...
  void inittf(JTextField[][] tf, int width, int height, JPanel contentPane, JTextField fragefeld,
