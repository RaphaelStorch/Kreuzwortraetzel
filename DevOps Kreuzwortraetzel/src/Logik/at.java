...
public class at extends JFrame {
	 ...
	 */
	public at() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(at.class.getResource("/JFrames/pics/Team STar Mario (1).png")));
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblNewLabel, GroupLayout.PREFERRED_SIZE, 243, Short.MAX_VALUE))
		);
